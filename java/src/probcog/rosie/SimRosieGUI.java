...
public class SimRosieGUI extends JFrame
{
	...
	private SimMobilePerceptionConnector perception;
	private SimMobileActuationConnector actuation;
	private LanguageConnector language;

    public SimRosieGUI(Properties props)
    {
		super("Rosie Chat");
    	...
    	perception = new SimMobilePerceptionConnector(soarAgent, props);
    	soarAgent.setPerceptionConnector(perception);

    	actuation = new SimMobileActuationConnector(soarAgent, perception.getRobot(), props);
