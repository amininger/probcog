...
public class TeleportObject implements ControlLaw
{
    ...
    public TeleportObject(Map<String, TypedValue> parameters)
    {
        assert (parameters.containsKey("object-id"));
        assert (parameters.containsKey("destination"));
		System.out.println("TELEPORT_OBJECT: " 
				+ parameters.get("object-id").getInt().toString() + " TO "
				+ parameters.get("destination").getInt().toString() );
    }
    ...
    public Collection<TypedParameter> getParameters()
    {
    	...
    	params.add(new TypedParameter("destination", TypedValue.TYPE_INT, true));
    	return params;
    }
