...
public class Behavior
{
    ...
    {
        return getMaxScore(gm, wavefront, xyts.size());
    }
    ...
    public double getMaxScore(GridMap gm, float[] wavefront, int numSamples)
    {
    ...
    {
        return getPctNearGoal(gm, wavefront, xyts.size());
    }
