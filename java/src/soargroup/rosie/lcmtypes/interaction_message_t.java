...
public final class interaction_message_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(soargroup.rosie.lcmtypes.interaction_message_t.class))
            return 0L;
 
        classes.add(soargroup.rosie.lcmtypes.interaction_message_t.class);
    ...
    public static soargroup.rosie.lcmtypes.interaction_message_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        soargroup.rosie.lcmtypes.interaction_message_t o = new soargroup.rosie.lcmtypes.interaction_message_t();
    ...
    public soargroup.rosie.lcmtypes.interaction_message_t copy()
    {
        soargroup.rosie.lcmtypes.interaction_message_t outobj = new soargroup.rosie.lcmtypes.interaction_message_t();
