...
public final class control_law_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    public String name;
    public int id;
    ...
    public soargroup.rosie.lcmtypes.condition_test_t termination_condition;
 
    public control_law_t()
    {
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x944d24f9e21c17a6L;
    ...
    {
        if (classes.contains(soargroup.rosie.lcmtypes.control_law_t.class))
            return 0L;
 
        classes.add(soargroup.rosie.lcmtypes.control_law_t.class);
        long hash = LCM_FINGERPRINT_BASE
             + soargroup.rosie.lcmtypes.typed_value_t._hashRecursive(classes)
             + soargroup.rosie.lcmtypes.condition_test_t._hashRecursive(classes)
            ;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        this.termination_condition._encodeRecursive(outs); 
 
    }
 
    public control_law_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public control_law_t(DataInput ins) throws IOException
    {
    ...
    public static soargroup.rosie.lcmtypes.control_law_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        soargroup.rosie.lcmtypes.control_law_t o = new soargroup.rosie.lcmtypes.control_law_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.termination_condition = soargroup.rosie.lcmtypes.condition_test_t._decodeRecursiveFactory(ins);
 
    }
 
    public soargroup.rosie.lcmtypes.control_law_t copy()
    {
        soargroup.rosie.lcmtypes.control_law_t outobj = new soargroup.rosie.lcmtypes.control_law_t();
        ...
        outobj.termination_condition = this.termination_condition.copy();
