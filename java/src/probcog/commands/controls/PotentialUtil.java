...
public class PotentialUtil
{
                                              ...
                                              Params params)
    {
        ...
        // Make points. XXX Would be nice to feed this in precomputed
        // since we are likely to reuse them.
    ...
    static public void main(String[] args)
    {
        ...
        for (double[] rxy: rxys) {
            ...
            // XXX
            double[] grad = getGradientSoftmax(rxy, LinAlg.resize(goal, 2), params);
