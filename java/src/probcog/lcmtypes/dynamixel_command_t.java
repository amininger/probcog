...
public final class dynamixel_command_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(probcog.lcmtypes.dynamixel_command_t.class))
            return 0L;
 
        classes.add(probcog.lcmtypes.dynamixel_command_t.class);
    ...
    public static probcog.lcmtypes.dynamixel_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        probcog.lcmtypes.dynamixel_command_t o = new probcog.lcmtypes.dynamixel_command_t();
    ...
    public probcog.lcmtypes.dynamixel_command_t copy()
    {
        probcog.lcmtypes.dynamixel_command_t outobj = new probcog.lcmtypes.dynamixel_command_t();
