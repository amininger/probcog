...
public final class dynamixel_status_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(probcog.lcmtypes.dynamixel_status_t.class))
            return 0L;
 
        classes.add(probcog.lcmtypes.dynamixel_status_t.class);
    ...
    public static probcog.lcmtypes.dynamixel_status_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        probcog.lcmtypes.dynamixel_status_t o = new probcog.lcmtypes.dynamixel_status_t();
    ...
    public probcog.lcmtypes.dynamixel_status_t copy()
    {
        probcog.lcmtypes.dynamixel_status_t outobj = new probcog.lcmtypes.dynamixel_status_t();
