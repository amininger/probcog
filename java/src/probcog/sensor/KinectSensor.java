...
public class KinectSensor
{
    ...
    public KinectSensor(Config calib_) throws IOException
    {
        calib = calib_;

        // Create the input view
        System.err.println("NFO: Initializing kinect calibration");
        String classname = calib.requireString("class");

        Object obj = ReflectUtil.createObject(classname, calib);
        assert (obj != null);
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            config = config.getChild("aprilCameraCalibration.camera0000");
        } catch (IOException ioex) {
        ...
        while (true) {
            ...
            for (int y = 0; y < kinect_status_t.HEIGHT; y++) {
                for (int x = 0; x < kinect_status_t.WIDTH; x++) {
